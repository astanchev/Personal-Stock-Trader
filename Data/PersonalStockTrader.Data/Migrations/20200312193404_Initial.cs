        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeFee = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Intervals_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeFee = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeePayments_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountStocks = table.Column<int>(nullable: false),
                    OpenTime = table.Column<DateTime>(nullable: false),
                    CloseTime = table.Column<DateTime>(nullable: true),
                    TypeOfTrade = table.Column<int>(nullable: false),
                    OpenClose = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataSets_Intervals_IntervalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutputSize = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MetaDatas_Intervals_IntervalId",
                        column: x => x.IntervalId,
                        principalTable: "Intervals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataSets_DateAndTime",
                table: "DataSets",
                column: "DateAndTime",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DataSets_IntervalId",
                table: "DataSets",
                column: "IntervalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeePayments_IsDeleted",
                table: "FeePayments",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Intervals_IsDeleted",
                table: "Intervals",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Intervals_StockId",
                table: "Intervals",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_MetaDatas_IntervalId",
                table: "MetaDatas",
                column: "IntervalId");

            migrationBuilder.CreateIndex(
                name: "IX_MetaDatas_IsDeleted",
                table: "MetaDatas",
                column: "IsDeleted");
